  ...
  return (
    <>
        <div className='w-screen-2xl h-screen container mx-auto md:px-20 px-4 flex pt-10 justify-center'>
            <div className='w-full md:mt-32 mt-16 justify-center'>
                <div className='space-y-12 w-full justify-center inline-block'>
                    ...
                    <p className='text-lg text-gray-400'>Expand your horizons and enrich your life through the transformative power of reading. With every book, unlock new worlds and experiences. </p>
                </div>
